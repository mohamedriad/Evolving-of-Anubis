...
class UI(QMainWindow):
    ...
    def intUI(self):
        ...
        Python_Action.triggered.connect(self.choosePython)
        CSharp_Action = QAction("C#", self)
        CSharp_Action.triggered.connect(self.chooseCSharp)
    ...
    def chooseCSharp(self):
        global lastChar
        lastChar = "cs"
        CSharp_Coloring.CSharpHighlighter(text)

    def choosePython(self):
        global lastChar
        lastChar = "py"
        Python_Coloring.PythonHighlighter(text)
